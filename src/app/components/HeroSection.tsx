            ...
            <div className="grid grid-cols-1 lg:grid-cols-12">
                <div className="col-span-7 place-self-center flex flex-col">
                    ...
                    <div className='flex flex-col mt-4 w-full lg:text-left flex-1 sm:justify-center sm:flex-row lg:justify-start md:flex-row px-8 sm:px-0'>
                        <button className='px-6 py-3 rounded-full bg-gradient-to-r from-orange-400 to-orange-600 hover:bg-orange-600 sm:w-fit hover:border hover:border-white'>Hire Me</button>
                        <button className='sm:w-fit px-6 py-3 rounded-full border border-orange-400 hover:text-orange-400 mt-4 sm:mt-0 md:ml-4'>
                            Download Resume
                        </button>
                    </div>
                </div>
                <div className="col-span-5">
                    ...
                    <div className="w-full h-full flex items-center justify-center place-self-center mt-4 lg:mt-0 mb-6">
                        <Image
                        className='rounded-full w-72 h-72 bg-gray-800 shadow-lg border border-orange-200' src="/images/ProfileRedJacket.png" style={{objectFit: "contain"}} width={300} alt="Hero Image"  height={300} />
                    </div>
