...
const Card = ({ props }: { props: { image: string, alt: string, title: string, categories: string[], description: string, href: string } }) => {
  ...
  return (
  <div className='flex group flex-col rounded-xl border bg-gray-800 hover:border-orange-500 cursor-pointer group-hover:shadow-lg' onClick={()=>{router.push(props.href)}}>
    ...
    <div className='p-4'>
      ...
      <p className='text-gray-400 group-hover:text-white mt-2'>{props.description}</p>
    </div>
  </div>
