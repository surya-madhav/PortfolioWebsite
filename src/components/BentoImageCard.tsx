...
export const BentoImageCard = ({
  ...
  return (
    <Link href={href} className="block h-full">
      <div
        className={cn(
          "group relative overflow-hidden rounded-xl border border-gray-800/30 bg-gray-900/30 backdrop-blur-sm hover:border-orange-500/50 transition-all duration-300 flex flex-col h-full hover:shadow-lg hover:shadow-orange-500/10 cursor-pointer",
          className
        )}
      >
        {/* Image Top Section */}
        <div className={cn(
          ...
          {videoUrl ? (
            ...
            <Image
              ...
              priority={className.includes("lg:col-span-2")}
            />
          )}
        ...
        <div className="p-4 sm:p-5 flex flex-col">
          ...
          <div className="mt-3 flex items-center text-orange-400 text-sm sm:text-base">
            <span className="group-hover:text-orange-300 transition-colors duration-200 flex items-center">
              View Project
